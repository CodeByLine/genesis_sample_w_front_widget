...
genesis_register_widget_area( array(
	'id'          => 'front-page-1',
	'name'        => __( 'Front Page 1', 'genesis_sample' ),
	'description' => __( 'This is the Front Page 1 section.', 'genesis_sample' ),
) );
genesis_register_widget_area( array(
	'id'          => 'front-page-2',
	'name'        => __( 'Front Page 2', 'genesis_sample' ),
	'description' => __( 'This is the Front Page 2 section.', 'genesis_sample' ),
) );
genesis_register_widget_area( array(
	'id'          => 'front-page-3',
	'name'        => __( 'Front Page 3', 'genesis_sample' ),
	'description' => __( 'This is the Front Page 3 section.', 'genesis_sample' ),
) );
...
genesis_register_widget_area(
	array(
		'id'          => "front-page-4",
		'name'        => __( "Front Page 4", 'genesis_sample-text-domain' ),
		'description' => __( "This is the front page 1 widget section.", 'genesis_sample-text-domain' ),
	)
);



// Enqueue Front Page Wdigets styles
wp_enqueue_style( 'front-styles', get_stylesheet_directory_uri() . '/style-front.css', array(), genesos_sample );
